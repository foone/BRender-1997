 ...
 */
br_device_clut * DeviceClutPseudoAllocate(br_device *dev, char *identifier)
{
	br_device_clut *self;
	int i;
...
static void BR_CMETHOD_DECL(br_device_clut_pseudo, free)(br_device_clut *self)
{
...
static br_token BR_CMETHOD_DECL(br_device_clut_pseudo, type)(br_device_clut *self)
{
	return BRT_DEVICE_CLUT;
}

static br_boolean BR_CMETHOD_DECL(br_device_clut_pseudo, isType)(br_device_clut *self, br_token t)
{
	return (t == BRT_DEVICE_CLUT) || (t == BRT_OBJECT);
}

static br_int_32 BR_CMETHOD_DECL(br_device_clut_pseudo, space)(br_device_clut *self)
{
	return sizeof(br_device_clut);
}

static struct br_tv_template * BR_CMETHOD_DECL(br_device_clut_pseudo,queryTemplate)(br_device_clut *self)
{
	deviceClutTemplate.res = Device3DfxResource(Object3DfxDevice(self));
	return &deviceClutTemplate;
}

static br_error BR_CMETHOD_DECL(br_device_clut_pseudo, entrySet)
...
static br_error BR_CMETHOD_DECL(br_device_clut_pseudo, entryQuery)
...
static br_error BR_CMETHOD_DECL(br_device_clut_pseudo, entrySetMany)
...
static br_error BR_CMETHOD_DECL(br_device_clut_pseudo, entryQueryMany)
...
static struct br_device_clut_dispatch deviceClutDispatch = {
	...
	NULL,
	NULL,
	BR_CMETHOD_REF(br_device_clut_pseudo,	free),
	BR_CMETHOD_REF(br_object_3dfx,			identifier),
	BR_CMETHOD_REF(br_device_clut_pseudo,	type),
	BR_CMETHOD_REF(br_device_clut_pseudo,	isType),
	BR_CMETHOD_REF(br_object_3dfx,			device),
	BR_CMETHOD_REF(br_device_clut_pseudo,	space),

	BR_CMETHOD_REF(br_device_clut_pseudo,	queryTemplate),
	...
	BR_CMETHOD_REF(br_device_clut_pseudo,	entrySet),
	BR_CMETHOD_REF(br_device_clut_pseudo,	entryQuery),
	BR_CMETHOD_REF(br_device_clut_pseudo,	entrySetMany),
	BR_CMETHOD_REF(br_device_clut_pseudo,	entryQueryMany),
};
