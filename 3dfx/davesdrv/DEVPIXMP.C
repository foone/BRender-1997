...
br_error AllocateSysMemPixelmap(br_device_pixelmap *self, br_device_pixelmap **newpm, int w, int h);
...
//			return BRE_DEV_ALREADY_INIT;
			...
			return(AllocateSysMemPixelmap(self, newpm, mt.width, mt.height));
		}
