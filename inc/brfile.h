 ...
 *
 * $Id: brfile.h 2.3 1996/10/03 11:09:35 sam Exp $
 * $Locker: $
 *
...
typedef void * BR_CALLBACK brfile_open_read_cbfn(const char *name, br_size_t n_magics,
...
typedef struct br_filesystem {
	 ...
	 * from the front of the file and pass them to an 'identify'
