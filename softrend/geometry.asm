...
Vertex_OS_TransformProject proc self:ptr br_geometry, renderer:ptr br_renderer
...
next:
	...
	ret
Vertex_OS_TransformProject endp
...
Vertex_TransformProjectOutcode proc self:ptr br_geometry, renderer:ptr br_renderer
	mov ecx,rend.nvertices
	mov edi,rend.temp_vertices
...
skipProjection:
	fstp st
	jmp endProjection
Vertex_TransformProjectOutcode endp
