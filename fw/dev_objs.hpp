...
class br_object {
	...
	public:
		...
		virtual	br_error BR_METHOD queryBuffer(br_uint_32 *pvalue, void *buffer, br_size_t buffer_size, br_token t);
...
class br_object_container : public br_object {
	...
	public:
		...
		virtual br_error BR_METHOD count(br_int_32 *pcount, br_token type, char *pattern, br_token_value *tv);
};
