 ...
 *
 * $Id: pstate.c 2.1 1996/03/15 17:24:59 sam Exp $
 * $Locker:  $
 *
 * Primitive state methods for ATI 3D Expression
 *
 */
...
BR_RCS_ID("$Id: pstate.c 2.1 1996/03/15 17:24:59 sam Exp $");


/* Macro to check that a SetState is succesful */
...
static struct br_tv_template_entry primitiveStateTemplateEntries[] = {
	...
	{BRT(PARTS_TL),				(size_t)&PrimPartsTokensATI,		Q | A | BRTV_ABS,	BRTV_CONV_LIST, },
};
#undef F
...
static void BR_CMETHOD_DECL(br_primitive_state_hardATI, free)(br_primitive_state *self)
{
   ObjectContainerRemove(self->plib, (br_object *)self);
   BrResFreeNoCallback(self);
}

static br_token BR_CMETHOD_DECL(br_primitive_state_hardATI, type)(br_primitive_state *self)
{
	return BRT_PRIMITIVE_STATE;
}

static br_boolean BR_CMETHOD_DECL(br_primitive_state_hardATI, isType)(br_primitive_state *self, br_token t)
{
	return (t == BRT_PRIMITIVE_STATE) || (t == BRT_OBJECT_CONTAINER) || (t == BRT_OBJECT);
}

static br_int_32 BR_CMETHOD_DECL(br_primitive_state_hardATI, space)(br_primitive_state *self)
{
	return sizeof(br_primitive_state);
}

static struct br_tv_template * BR_CMETHOD_DECL(br_primitive_state_hardATI,templateQuery)
...
/* ALL LINES WITH CUSTOM CONVERSIONS GIVE WARNINGS!! WHY?!?!?!? */
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partSet)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_token t,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partSetMany)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_token_value * tv,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQuery)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_uint_32 *pvalue,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryBuffer)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_uint_32 *pvalue,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryMany)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_token_value *tv,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryManySize)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryAll)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryAllSize)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_size_t *psize)
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partIndexQuery)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 *pnindex)
{
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partQueryCapability)(
		struct br_primitive_state *self,
		br_token part,
		br_int_32 index,
		br_token_value *buffer,
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, stateQueryPerformance)(
		struct br_primitive_state *self,
        br_fixed_lu *speed)
{
    return BRE_FAIL;
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, partDefault)(
		struct br_primitive_state *self,
		br_uint_32 mask)
{
	/*
...
static br_error BR_CMETHOD_DECL(br_primitive_state_hardATI, copy)(
		struct br_primitive_state *self,
...
static struct br_primitive_state_dispatch primitiveStateDispatch = {
   NULL,NULL,NULL,NULL,
	BR_CMETHOD_REF(br_primitive_state_hardATI,	free),
	BR_CMETHOD_REF(br_object_ati,			identifier),
	BR_CMETHOD_REF(br_primitive_state_hardATI, type),
	BR_CMETHOD_REF(br_primitive_state_hardATI, isType),
	BR_CMETHOD_REF(br_object_ati, 			device),
	BR_CMETHOD_REF(br_primitive_state_hardATI, space),

	BR_CMETHOD_REF(br_primitive_state_hardATI,	templateQuery),
	...
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partSet),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partSetMany),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQuery),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQueryBuffer),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQueryMany),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQueryManySize),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQueryAll),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partQueryAllSize),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partIndexQuery),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	partDefault),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	copy),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	renderBegin),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	renderEnd),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	rangesQueryF),
	BR_CMETHOD_REF(br_primitive_state_hardATI,	rangesQueryX),
   BR_CMETHOD_REF(br_primitive_state_hardATI,   partQueryCapability),
   BR_CMETHOD_REF(br_primitive_state_hardATI,   stateQueryPerformance),
};
