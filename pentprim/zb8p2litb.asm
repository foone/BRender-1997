...
;********************************
; Blended Lit Textured Power Of 2
;********************************


DRAW_ZTIB_I8_D16_POW2 macro minorX,direction,half,pow2
...
TriangleRender_ZTIB_I8_D16_POW2 macro pow2,powName
externdef c TriangleRasterise_ZTIB_I8_D16&powName&:proc

TriangleRender_ZTIB_I8_D16&powName proc dummy:dword, v0:ptr brp_vertex, v1:ptr brp_vertex, v2:ptr brp_vertex
	mov	eax,v0
	mov	ecx,v1	
...
TriangleRasterise_ZTIB_I8_D16&powName label proc
...
;										st(0)		st(1)		st(2)		st(3)		st(4)		st(5)		st(6)		st(7)
	...
	DRAW_ZTIB_I8_D16_POW2 x1,DRAW_LR,top,pow2
	DRAW_ZTIB_I8_D16_POW2 x2,DRAW_LR,bottom,pow2
	ret

drawRL:
	DRAW_ZTIB_I8_D16_POW2 x1,DRAW_RL,top,pow2
	DRAW_ZTIB_I8_D16_POW2 x2,DRAW_RL,bottom,pow2
	ret
TriangleRender_ZTIB_I8_D16&powName endp
endm

	if PARTS and PART_8Z

TriangleRender_ZTIB_I8_D16_POW2 3,_8
TriangleRender_ZTIB_I8_D16_POW2 4,_16
TriangleRender_ZTIB_I8_D16_POW2 5,_32
TriangleRender_ZTIB_I8_D16_POW2 6,_64
TriangleRender_ZTIB_I8_D16_POW2 7,_128
TriangleRender_ZTIB_I8_D16_POW2 8,_256
TriangleRender_ZTIB_I8_D16_POW2 10,_1024
