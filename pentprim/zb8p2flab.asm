...
;*************************************
; Blended Flat Lit Textured Power Of 2
;*************************************

DRAW_ZTB_I8_D16_POW2_FLAT macro minorX,direction,half,pow2
...
TriangleRender_ZTB_I8_D16_POW2_FLAT macro pow2,powName
externdef c TriangleRasterise_ZTB_I8_D16&powName&:proc
TriangleRender_ZTB_I8_D16&powName proc dummy:dword, v0:ptr brp_vertex, v1:ptr brp_vertex, v2:ptr brp_vertex
	mov	eax,v0
	mov	ecx,v1	
	...
	;half cycle wasted
	call TriangleSetup_ZT_FLAT_LIT

TriangleRasterise_ZTB_I8_D16&powName label proc
...
;										st(0)		st(1)		st(2)		st(3)		st(4)		st(5)		st(6)		st(7)
	...
	DRAW_ZTB_I8_D16_POW2_FLAT x1,DRAW_LR,top,pow2
	DRAW_ZTB_I8_D16_POW2_FLAT x2,DRAW_LR,bottom,pow2
	ret

drawRL:
	DRAW_ZTB_I8_D16_POW2_FLAT x1,DRAW_RL,top,pow2
	DRAW_ZTB_I8_D16_POW2_FLAT x2,DRAW_RL,bottom,pow2
	ret
TriangleRender_ZTB_I8_D16&powName endp
endm

	if PARTS and PART_8Z

TriangleRender_ZTB_I8_D16_POW2_FLAT 3,_8_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 4,_16_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 5,_32_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 6,_64_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 7,_128_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 8,_256_FLAT
TriangleRender_ZTB_I8_D16_POW2_FLAT 10,_1024_FLAT
