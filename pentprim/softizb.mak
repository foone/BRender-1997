...
#
# $Id: softizb.mak 1.2 1997/02/16 20:15:51 jon Exp $
# $Locker: $
#
...
BLD_BASE:=sizb
TARGET=softizb$(LIB_SUFFIX_T).dll
EXPORTS:=softizb.exf
EXPORT_TYPE:=1
CFLAGS+=
LDLIBS+=\
...
CFLAGS+=-DPARTS=PART_8Z_BLEND -DBASED_$(BR_BASE_TYPE)=1
ASFLAGS+=-DPARTS=PART_8Z_BLEND -DBASED_$(BR_BASE_TYPE)=1
