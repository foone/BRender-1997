 ...
 *
 * $Id: PSTATE.C 1.8 1996/12/13 15:04:26 sam Exp $
 * $Locker: $
 *
...
BR_RCS_ID("$Id: PSTATE.C 1.8 1996/12/13 15:04:26 sam Exp $");
...
static br_tv_template_entry partPrimitiveTemplateEntries[] = {
	...
	{BRT(FORCE_BACK_B),		F(prim.flags),			Q | S | A,	BRTV_CONV_BIT,	PRIMF_FORCE_BACK,			1},
