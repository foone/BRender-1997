 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_s3_dd, directLock)(br_device_pixelmap *self, br_boolean block)
{
	if(block == BR_FALSE)
		return BRE_OK;
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_s3_dd, directUnlock)(br_device_pixelmap *self)
{
